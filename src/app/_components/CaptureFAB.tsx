    ...
    <>
      ...
      >
        <svg viewBox="0 0 24 24" width="20" height="20" aria-hidden>
          ...
          />
          <path
            d="M5 11a1 1 0 0 1 2 0 5 5 0 0 0 10 0 1 1 0 0 1 2 0 7 7 0 0 1-6 6.92V21a1 1 0 0 1-2 0v-3.08A7 7 0 0 1 5 11z"
            fill="currentColor"
          />
        </svg>
      </button>
      {open && (
        <CaptureSheet onClose={close} initialDestination={initialDest} />
      )}
    </>
  );
}
